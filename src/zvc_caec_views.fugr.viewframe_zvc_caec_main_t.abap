*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVC_CAEC_MAIN_T
*   generation date: 28.02.2024 at 09:25:22
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVC_CAEC_MAIN_T     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_MAIN_T'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVC_CAEC_MAIN_T_EXTRACT
TOTAL = ZVC_CAEC_MAIN_T_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_MAIN_T'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVC_CAEC_MAIN_T-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVC_CAEC_MAIN_T_EXTRACT
TOTAL = ZVC_CAEC_MAIN_T_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVC_CAEC_MAIN_T-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_MAIN_T'
...
TOTAL = ZVC_CAEC_MAIN_T_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVC_CAEC_MAIN_T-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVC_CAEC_MAIN_T-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_MAIN_T'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVC_CAEC_MAIN_T-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVC_CAEC_MAIN_T_EXTRACT
TOTAL = ZVC_CAEC_MAIN_T_TOTAL
