...
*   generation date: 27.02.2024 at 14:38:07
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_VALUE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVC_CAEC_VALUE_EXTRACT
TOTAL = ZVC_CAEC_VALUE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_VALUE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVC_CAEC_VALUE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVC_CAEC_VALUE_EXTRACT
TOTAL = ZVC_CAEC_VALUE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVC_CAEC_VALUE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_VALUE'
...
TOTAL = ZVC_CAEC_VALUE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVC_CAEC_VALUE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVC_CAEC_VALUE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_VALUE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVC_CAEC_VALUE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVC_CAEC_VALUE_EXTRACT
TOTAL = ZVC_CAEC_VALUE_TOTAL
