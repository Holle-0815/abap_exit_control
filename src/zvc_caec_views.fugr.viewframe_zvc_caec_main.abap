...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_MAIN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVC_CAEC_MAIN_EXTRACT
TOTAL = ZVC_CAEC_MAIN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_MAIN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVC_CAEC_MAIN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVC_CAEC_MAIN_EXTRACT
TOTAL = ZVC_CAEC_MAIN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVC_CAEC_MAIN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVC_CAEC_MAIN'
...
TOTAL = ZVC_CAEC_MAIN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVC_CAEC_MAIN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVC_CAEC_MAIN-UPD_FLAG NE SPACE.
